...
struct MainMenuData
{
	...
	wchar_t *modmanager_status;
	wchar_t *modmanager_info;
...
private:
	...
	v2s32 m_size_server;
	std::string getSelectedGamePath();
	void refreshLocalModlist();
	bool createErrorStatus(std::string errorcode);
	void createModDescription(ModManagerSpec spec);
};
